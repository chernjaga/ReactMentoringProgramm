...
} from './FilterPanelStyleSet.styled';
...
const sortOptions: string[] = ['RELEASE', 'TITLE', 'RATING'];
...
const FilterPanelComponent: React.FC<{ filterItems: FilterItems }> = ({
    ...
    const setFilterValue: (filterValue: string, key: number, event: React.MouseEvent) => void = (
        filterValue: string,
        key: number,
    ...
    const changeListHandler: (sortBy: string, filterBy: string) => void = useCallback(
        (sortBy: string, filterBy: string): void => {
